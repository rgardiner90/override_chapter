...
short_1995 <- short_1995 %>%
  select(-state_code, -notes)

short_1996 <- short_1996 %>%
  select(-docket_n, -decs_day, -agency_r)

short_1997 <- short_1997 %>%
  select(-decs_day, -agency_r)
...
```{r}
long_1997 <- read_excel("data/old data/1997.xlsx")
...
-Double check that the column differences are just naming conventions and not real differences.  
- rename columns 
- assign election type 1996-1998
- Merge the 4 years
- Merge covariates